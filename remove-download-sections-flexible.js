...
function removeDownloadSections(content) {
    ...
    const downloadSectionPattern2 = /<div class="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 text-white text-center mb-12">\s*<h3[^>]*>Ready to Improve Your[^<]*<\/h3>\s*<p[^>]*>Get your personalized RA wellness plan[^<]*<\/p>\s*<a[^>]*>Download Being Well App<\/a>\s*<\/div>/gs;
    ...
    const downloadSectionPattern3 = /<div class="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 text-white text-center mb-12">\s*<h3[^>]*>Ready to Improve Your[^<]*<\/h3>\s*<p[^>]*>Get your personalized RA wellness plan[^<]*<\/p>\s*<a[^>]*href="[^"]*"[^>]*>Download Being Well App<\/a>\s*<\/div>/gs;
